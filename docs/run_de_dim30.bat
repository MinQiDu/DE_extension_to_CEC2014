@echo off
cd /d "C:\Users\user\Documents\MyCode\VisualStudio\meta_algo\DE_extension_to_CEC2014\x64\Release"
...
:: ========== f1 ==========
echo Running f1
DE_extension_to_CEC2014.exe %dim% %pop_size% %mCR% %mF% %c% %p% 1 %archive% "%algo%"

:: ========== f2 ==========
echo Running f2
DE_extension_to_CEC2014.exe %dim% %pop_size% %mCR% %mF% %c% %p% 2 %archive% "%algo%"

:: ========== f3 ==========
echo Running f3
DE_extension_to_CEC2014.exe %dim% %pop_size% %mCR% %mF% %c% %p% 3 %archive% "%algo%"

:: ========== f4 ==========
echo Running f4
DE_extension_to_CEC2014.exe %dim% %pop_size% %mCR% %mF% %c% %p% 4 %archive% "%algo%"

:: ========== f5 ==========
echo Running f5
DE_extension_to_CEC2014.exe %dim% %pop_size% %mCR% %mF% %c% %p% 5 %archive% "%algo%"

:: ========== f6 ==========
echo Running f6
DE_extension_to_CEC2014.exe %dim% %pop_size% %mCR% %mF% %c% %p% 6 %archive% "%algo%"

:: ========== f7 ==========
echo Running f7
DE_extension_to_CEC2014.exe %dim% %pop_size% %mCR% %mF% %c% %p% 7 %archive% "%algo%"

:: ========== f8 ==========
echo Running f8
DE_extension_to_CEC2014.exe %dim% %pop_size% %mCR% %mF% %c% %p% 8 %archive% "%algo%"

:: ========== f9 ==========
echo Running f9
DE_extension_to_CEC2014.exe %dim% %pop_size% %mCR% %mF% %c% %p% 9 %archive% "%algo%"

:: ========== f10 ==========
echo Running f10
DE_extension_to_CEC2014.exe %dim% %pop_size% %mCR% %mF% %c% %p% 10 %archive% "%algo%"

:: ========== f11 ==========
echo Running f11
DE_extension_to_CEC2014.exe %dim% %pop_size% %mCR% %mF% %c% %p% 11 %archive% "%algo%"

:: ========== f12 ==========
echo Running f12
DE_extension_to_CEC2014.exe %dim% %pop_size% %mCR% %mF% %c% %p% 12 %archive% "%algo%"

:: ========== f13 ==========
echo Running f13
DE_extension_to_CEC2014.exe %dim% %pop_size% %mCR% %mF% %c% %p% 13 %archive% "%algo%"
